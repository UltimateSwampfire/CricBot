...
with device:
    ...
    while True:
        ...
        if synced:
            ...
            if curr_point != (0, 0, 0):
                # if len(pts_lst) > 0:
                #     if pts_lst[-1][2] < curr_point[2]:
                #         falseDetec = True
                #     else:
                #         falseDetec = False
                #     # print("Prev Point : {} Current Point :{}".format(pts_lst[-1][1],curr_point[1]))

                #     if pts_lst[-1][1] > 50+curr_point[1]:
                #         downward += 1
                #         # print("Downward : ", downward)
                #     else :
                #         upward +=1
                #     if downward >0 and upward >3:
                #         print("BOUNCE DETECTED")
                #         # pts_lst = [pts_lst[-1]]
                #         downward = 0
                #         upward = 0

                if curr_point[2] < max_distance and falseDetec == False: #ball within range no false detect
...
x_parametric = np.arange(-1.5,1.5,0.01)
...
ax[1][0].scatter(x_parametric, z_parametric)
...
ax[1][1].scatter(z_parametric,y_parametric)
